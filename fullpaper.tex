...
We present VHASH as a DHT designed to take inter-node latency information into account when generating an overlay for massive scale use.  VHash creates 

Our paper presents the following:
\begin{itemize}
	\item We define the pr
\end{itemize}
...
\begin{itemize}
	\item Assignment of keys and responsibility
